const day3Inputs = `..975..95..................717..........................................747................................................622..............
...
const parsedDay3Inputs = day3Inputs.split("\n");

// 38842162 too low
// 22848709 last answer

const numbers = parsedDay3Inputs.map((i) => [...i.matchAll(/\d+/g)]);
const matrix = parsedDay3Inputs.map((i) => i.split(""));

// 520019 correct
const partNumbers = numbers.reduce((sum, numberMatches, rowIdx) => {
  const rowMatchSum = numberMatches.reduce((rowSum, numberMatch) => {
    ...
    const range = [
      strIdx - 1,
      ...Array.from({ length: valueToCheck.length + 1 }, (_, i) => i + strIdx),
    ];
    ...
    return (rowSum = isPartNumber ? rowSum + +valueToCheck : rowSum);
  }, 0);
...
const gears = possibleGears.reduce((gearList: number, gearMatches, rowIdx) => {
  const rowMatches = gearMatches.reduce((gearRatio: number, gearMatch, idx) => {
    ...
    if (isGear) {
      gearRatio += adjacentNums.reduce((acc, curr) => (acc *= curr), 1);
      // console.debug(gearRatio);
    }

    return gearRatio;
  }, 0);

  return (gearList += rowMatches);
}, 0);
