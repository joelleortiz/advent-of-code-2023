const day2Inputs = `Game 1: 5 red, 1 green, 2 blue; 2 green, 8 blue, 6 red; 8 red, 3 blue, 2 green; 6 red, 1 green, 19 blue; 1 red, 17 blue
...
const parsedDay2Inputs = day2Inputs.split("\n");
...
const day2Result = parsedDay2Inputs.reduce((acc, curr) => {
